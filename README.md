...
Core Path lessons: 25
Explore More lessons: 53
Total lesson steps: 432
Lesson interactive tasks: 331
Combined interactive/checkpoint tasks: 499
Production-like build/sort tasks: 90 lesson tasks (27.2% of interactive lesson work)
Repair-tagged tasks: 52 lesson tasks plus 21 checkpoint repair items
Transfer-tagged tasks: 47 lesson tasks plus 21 checkpoint transfer items
...
Historical v1.11 count before the v1.12 polish pass: **77 lessons**, **21 phases**, **415 lesson steps**, **317 interactive tasks**, **168 authored checkpoint items**, **112 enriched glossary metadata records**, and **25 fidel families**. For current counts, see the v1.13 section below.
...
Historical v1.12 structural count before v1.13 additions: **78 lessons**, **21 phases**, **432 lesson steps**, **331 lesson interactive tasks**, **499 combined interactive/checkpoint tasks**, **168 authored checkpoint items**, **112 glossary items**, **112 enriched glossary metadata records**, and **25 fidel families**.
...
Current structural count after v1.13: **78 lessons**, **21 phases**, **432 lesson steps**, **331 lesson interactive tasks**, **499 combined interactive/checkpoint tasks**, **168 authored checkpoint items**, **112 glossary items**, **112 enriched glossary metadata records**, and **25 fidel families**.
